...
allButton.addEventListener("click",listAllFoods);
...
koreaButton.addEventListener("click",listKoreaFoods);
...
japanButton.addEventListener("click",listJapanFoods);
...
chinaButton.addEventListener("click",listChinaFoods);
